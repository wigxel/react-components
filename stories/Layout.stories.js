...
const ClusterOutline = ({ children }) => {
	return (
		<Cluster.Small>
			<Outline color="whitesmoke">{children}</Outline>
		</Cluster.Small>
	)
}
			...
			<Stack large>
				...
				<Outline all>
					<Stack>
						...
						<P>
							I go up, i need to go up. Can i go and play in the hay, we play in
							the Hay,. Can Jack and i play in the hay?
						</P>
						<ul>
			...
			<Theme>
				<Stack>
					<header>
						<H2>Clusters</H2>
						<P>
							This creates inner-spacing (padding) for the parent. Observe the
							space from all directions between the red border and the text
							content
						</P>
					</header>
							...
							<ClusterOutline>
								<Stack noExtraSpace>
									...
									<P>
										...
										est, adipisci labore amet necessitatibus commodi,
										reprehenderit aperiam et cumque a nesciunt harum delectus.
										Recusandae, eveniet iste provident delectus consequuntur
										autem similique repellendus. Asperiores labore facere quis
										sint. Iste, maiores! Deserunt dignissimos veritatis minima
										laboriosam, quaerat cum, ad iure eius itaque possimus error
										suscipit corrupti, soluta debitis ab! Temporibus cumque
