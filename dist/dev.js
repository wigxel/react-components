...
var CardStyle = function CardStyle() {
  ...
  return styled.article(_templateObject(), color('bgcolor'), withProp('static', css(_templateObject2()), con), withProp('clickable', css(_templateObject3()), con), withProp('shadow', css(_templateObject4()), con), withProp('outlineDanger', css(_templateObject5(), color('danger'))));
};
var fullWidth = withProp('fullwidth', css(_templateObject6()));
var color = theme;
var sizes = {
  bigDestktop: 1800,
  // 1800 above
...
var media = Object.keys(sizes).reduce(function (acc, label) {
  acc[label] = function () {
    return css(_templateObject7(), sizes[label] / 16, css.apply(void 0, arguments));
  };
...
var InputStyle = styled.div(_templateObject$1(), function (props) {
  return props.focus && css(_templateObject2$1(), color('primary'));
}, fullWidth(), function (props) {
  return props.large && css(_templateObject3$1());
});
...
var InputStyle$1 = styled.input(_templateObject$2(), theme('whitesmoke'), theme('primary'), theme('primary'), theme('primary'), withProp('large')(css(_templateObject2$2(), theme('primary'))), function (props) {
  return trace('the Property from the input template literal', props.theme);
}, fullWidth(), withProp('large')(css(_templateObject3$2())));
var Input = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(InputStyle$1, _extends$1({}, props, {
    ref: ref
  }));
});
var IconInputStyle = styled.div(_templateObject4$1(), fullWidth(), theme('primary'), function (props) {
  return props.large && css(_templateObject5$1());
}, function (props) {
  return props.large && css(_templateObject6$1());
});
var IconInput = function IconInput(props) {
  return React__default.createElement("div", null, "Change This");
};
var RadioStyle = styled.label(_templateObject7$1(), theme('primary'), theme('primary'));
var RadioInput = React__default.forwardRef(function (props, ref) {
  return React__default.createElement(RadioStyle, null, React__default.createElement("input", _extends$1({
    ref: ref,
    type: "radio"
  }, props)), React__default.createElement("span", null));
});
var RadioLabelStyle = styled.div(_templateObject8(), fullWidth(), ''
/* border: solid 1px black; */
);
...
var ButtonStyle = styled.button(_templateObject$3(), color('accent'), color('accent'), withProp('primary')(css(_templateObject2$3(), color('primary'), color('primary'))), withProp('danger')(css(_templateObject3$3(), color('danger'), color('danger'))), withProp('outline')(css(_templateObject4$2())), withProp('large')(css(_templateObject5$2())), withProp('circle')(css(_templateObject6$2())), fullWidth());
...
var SearchStyle = styled.div(_templateObject$4(), function (props) {
...
var StyledCard = styled(CardStyle({
  shadow: true
...
var DialogStyle = styled.section(_templateObject$6(), propIs('size')(ModalSize.small)(css(_templateObject2$4())), propIs('size')(ModalSize.large)(css(_templateObject3$4())), propIs('show')(function (show) {
  return show === true;
})(css(_templateObject4$3())));
...
var StackStyle = styled.div(_templateObject$a(), withProp('noExtraSpace')(css(_templateObject2$6())), propSizes.map(function (_ref) {
  ...
  return withProp(prop)(css(_templateObject3$5(), size));
}));
...
var LargeS = styled.span(_templateObject$c(), withProps(["vertical", "y"])(css(_templateObject2$8())), withProps(["horizontal", "x"])(css(_templateObject3$6())));
...
var Outliner = styled.div(_templateObject$f(), outlineColor, withProp('all')(css(_templateObject2$a(), outlineColor)));
...
var Wrap = styled.div(_templateObject$g());
...
var JumbotronStyle = styled.div(_templateObject$h(), function (props) {
  return props.theme.primary;
});
...
var Heading = styled.span(_templateObject$i(), function (props) {
  return props.bold ? 'bold' : props.light ? '300' : '400';
}, function (props) {
  return props.$fontSize;
});
var H1 = function H1(props) {
  return React__default.createElement(Heading, _extends$1({}, props, {
    as: "h1",
    $fontSize: "43px"
  }));
};
...
var ParagraphStyle = styled.p(_templateObject$j(), function (props) {
  return props.small && css(_templateObject2$c());
});
