...
var fullWidth = function fullWidth() {
  return withProp('fullwidth')(css(_templateObject6()));
};
...
var InputStyle$1 = styled.input(_templateObject$2(), function (props) {
...
var IconInputStyle = styled.div(_templateObject4$1(), fullWidth(), function (a) {
  return a.theme.primary;
}, function (props) {
...
var RadioStyle = styled.label(_templateObject7$1(), function (a) {
  return a.theme.grey;
}, function (a) {
  return a.theme.primary;
});
...
var RadioLabelStyle = styled.div(_templateObject8(), ''
...
var H4 = styled.h4(_templateObject4$5(), Heading);
...
var ParagraphStyle = styled.p(_templateObject$i(), function (props) {
  return props.small && css(_templateObject2$d());
});
